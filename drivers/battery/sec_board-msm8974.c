...
static struct sec_fuelgauge_info *sec_fuelgauge = NULL;
	...
	defined(CONFIG_MACH_KLTE_VZW) || defined(CONFIG_SEC_LOCALE_CHN) || \
	defined(CONFIG_MACH_KACTIVELTE_EUR) || defined(CONFIG_MACH_KACTIVELTE_ATT) || defined(CONFIG_MACH_KLTE_AUS_TEL)
...
#define TEMP_LOW_RECOVERY_NORMAL	17
#define TEMP_HIGH_THRESHOLD_LPM		490
#define TEMP_HIGH_RECOVERY_LPM		480
